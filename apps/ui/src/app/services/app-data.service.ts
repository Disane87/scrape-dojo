...
export class AppDataService {
    ...
    async initialize(): Promise<void> {
        ...
        try {
            ...
            console.log(`✅ Action metadata loaded: ${Object.keys(actionMetadata).length} actions`);
            
            // Lade Runs um laufende Jobs zu erkennen
            // Dies passiert asynchron im Hintergrund
            this.runsStore.load().catch(err => 
 ...
 */
export function initializeAppData(appDataService: AppDataService): () => Promise<void> {
