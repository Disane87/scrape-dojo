import { Component, Input, Output, EventEmitter, signal, effect, OnInit, OnDestroy, PLATFORM_ID, inject, CUSTOM_ELEMENTS_SCHEMA } from '@angular/core';
...
export class JsonEditorComponent implements OnInit, OnDestroy {
    ...
    private initEditor() {
        ...
        // Get current theme
        const currentTheme = this.themeService.resolvedTheme() === 'dark' ? 'dojo-dark' : 'dojo-light';
