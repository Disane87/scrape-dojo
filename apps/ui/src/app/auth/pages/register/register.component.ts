            ...
            <div class="relative w-full max-w-md motion-safe:animate-[fadeInUp_0.5s_ease-out]">
                ...
                <div class="bg-dojo-surface backdrop-blur-xl rounded-2xl shadow-2xl shadow-black/50 border border-dojo-border p-8">
                    ...
                    <div class="flex justify-center mb-8">
                        <div class="relative">
                            <div class="absolute inset-0 bg-red-500/30 blur-2xl rounded-full scale-150"></div>
                    ...
                    <form (ngSubmit)="onSubmit()" class="space-y-4">
                        ...
                        <div class="space-y-2">
                            ...
                            @if (password !== confirmPassword && confirmPassword.length > 0) {
                                <div class="flex items-center gap-1.5 text-xs text-red-400 motion-safe:animate-[fadeIn_0.2s_ease-out]">
                                    <iconify-icon icon="mdi:alert-circle"></iconify-icon>
                                    <span transloco="auth.register.passwordMismatch"></span>
                                </div>
                            }
                            @if (password === confirmPassword && confirmPassword.length > 0) {
                                <div class="flex items-center gap-1.5 text-xs text-emerald-400 motion-safe:animate-[fadeIn_0.2s_ease-out]">
