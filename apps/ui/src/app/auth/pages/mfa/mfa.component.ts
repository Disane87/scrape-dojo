...
export class MfaComponent implements OnInit {
    ...
    constructor() {
        ...
        this.mfaChallengeToken = params['mfa_challenge_token'] || params['mfaChallengeToken'] || '';
        this.setupRequired =
            ...
            .pipe(
                ...
                catchError((err) => {
                    if (err?.name === 'TimeoutError') {
                        this.errorMessage = 'MFA setup request timed out. Please try again.';
                        return EMPTY;
                    }
            ...
            .subscribe({
                next: (resp) => {
                    ...
                    if (!this.qrCodeDataUrl && !this.secret) {
                        this.errorMessage = this.transloco.translate('auth.mfa.setup_failed');
                    }
        ...
        this.http
            ...
            .subscribe({
                ...
                error: (err) => {
                    ...
                    if (typeof message === 'string' && message.toLowerCase().includes('mfa setup required')) {
