      ...
      >
        ...
        >
          ...
          <h2
            ...
            transloco="auth.login.title"
          >
            Anmelden
          </h2>
          <p
            class="text-center text-dojo-text-muted text-sm mb-8"
            transloco="auth.login.subtitle"
          ></p>
          ...
          @if (authService.oidcConfig()?.enabled) {
            <div class="flex items-center gap-4 my-6">
              ...
              <span
                class="text-dojo-text-subtle text-sm"
                transloco="auth.login.or"
              ></span>
              <div class="flex-1 h-px bg-dojo-border"></div>
            </div>
            <button
            ...
            >
              ...
              <span>{{
                'auth.login.oidc'
                  | transloco: { provider: authService.oidcConfig()?.name }
              }}</span>
            </button>
          }
          ...
          <div class="text-center mt-8 pt-6 border-t border-dojo-border">
            <span
              ...
              transloco="auth.login.noAccount"
            ></span>
            <a
              routerLink="/register"
