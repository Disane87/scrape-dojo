...
export class JwtStrategy extends PassportStrategy(Strategy, 'jwt') {
    ...
    constructor(
        ...
        const requireMfa = configService.get<string>('SCRAPE_DOJO_AUTH_REQUIRE_MFA', 'true') === 'true';
        super({
            ...
            secretOrKey: configService.get<string>('SCRAPE_DOJO_AUTH_JWT_SECRET', 'jwt-secret-change-me'),
        });
