...
Handlebars.registerHelper("ne", (a: any, b: any): boolean => {
    return a !== b;
});

Handlebars.registerHelper("isUndefined", (value: any): boolean => {
    return value === undefined;
});

Handlebars.registerHelper("isDefined", (value: any): boolean => {
    return value !== undefined;
});

// Register typeof helper
Handlebars.registerHelper("typeof", (value: any): string => {
    return typeof value;
});
