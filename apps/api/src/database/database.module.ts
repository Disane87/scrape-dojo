...
const entities = [Run, RunStep, RunAction, RunLog, ScrapeData, ScrapeSchedule, VariableEntity, SecretEntity, UserEntity];
    ...
    imports: [
        TypeOrmModule.forRootAsync({
            ...
            useFactory: async (configService: ConfigService): Promise<TypeOrmModuleOptions> => {
                ...
                const synchronize = configService.get<string>('DB_SYNCHRONIZE', nodeEnv === 'production' ? 'false' : 'true') === 'true';
                ...
                if (dbType === 'sqlite') {
                    const dbPath = configService.get<string>('DB_DATABASE', './data/scrape-dojo.db');
                ...
                if (dbType === 'mysql') {
                    ...
                    const database = configService.get<string>('DB_DATABASE', 'scrape_dojo');
                ...
                const defaultDbPath = path.join(process.cwd(), 'data', 'scrape-dojo.db');
